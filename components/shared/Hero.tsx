...
export function Hero({
  ...
  return (
    <section className="relative min-h-[40vh] flex items-center justify-center pt-32 pb-20 bg-secondary-foreground overflow-hidden">
      ...
      <div className="container relative z-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-center">
          ...
          <motion.p 
            ...
            className="text-center text-zinc-100 text-lg md:text-xl md:max-w-5xl leading-relaxed mb-12"
          >
            {subtitle}
          </motion.p>
            ...
            >
              <Link href={buttonHref}>
                <Button 
                  variant="default" 
                  size="lg"
                  className="h-14 px-10 text-sm font-bold tracking-widest transition-all hover:scale-105 active:scale-95"
                >
                  {buttonText}
      ...
      <div className="absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-secondary-foreground to-transparent" />
    </section>
  );
}